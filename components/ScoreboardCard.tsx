                  ...
                  style={[
                    ...
                    awayWin && styles.winnerScore,
                    {
                      ...
                      color: awayFlash.interpolate({
                        inputRange: [0, 1],
                        outputRange: [awayWin ? '#F0642B' : '#0B2346', '#F0642B'],
                      }),
                    },
                  ]}
                >
                  ...
                  style={[
                    ...
                    homeWin && styles.winnerScore,
                    {
                      ...
                      color: homeFlash.interpolate({
                        inputRange: [0, 1],
                        outputRange: [homeWin ? '#F0642B' : '#0B2346', '#F0642B'],
                      }),
                    },
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  scoreRow: {
    ...
    marginBottom: 1,
    borderRadius: 8,
    backgroundColor: 'rgba(255,247,233,0.08)',
  },
  scoreRowWinner: {
    backgroundColor: 'rgba(240,100,43,0.22)',
    borderWidth: 1,
    borderColor: '#F0642B',
  },
  teamCodeCellText: {
